...
public class ZhaopinxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：工作年限
	 */
	public void setGongzuonianxian(Integer gongzuonianxian) {
		this.gongzuonianxian = gongzuonianxian;
	}
	/**
	 * 获取：工作年限
	 */
	public Integer getGongzuonianxian() {
	 ...
	 * 设置：企业链接
	 */
	public void setQiyelianjie(String qiyelianjie) {
		this.qiyelianjie = qiyelianjie;
	}
	/**
	 * 获取：企业链接
	 */
	public String getQiyelianjie() {
		return qiyelianjie;
	}
	/**
	 * 设置：企业账号
