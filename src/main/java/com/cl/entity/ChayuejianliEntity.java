...
public class ChayuejianliEntity<T> implements Serializable {
	...
	private String mianshizhuangtai;
	 ...
	 * 设置：面试状态
	 */
	public void setMianshizhuangtai(String mianshizhuangtai) {
		this.mianshizhuangtai = mianshizhuangtai;
	}
	/**
	 * 获取：面试状态
	 */
	public String getMianshizhuangtai() {
		return mianshizhuangtai;
	}
