...
public class ToudijianliEntity<T> implements Serializable {
	...
	private String chayuezhuangtai;
	 ...
	 * 设置：查阅状态
	 */
	public void setChayuezhuangtai(String chayuezhuangtai) {
		this.chayuezhuangtai = chayuezhuangtai;
	}
	/**
	 * 获取：查阅状态
	 */
	public String getChayuezhuangtai() {
		return chayuezhuangtai;
	}
	/**
	 * 设置：跨表用户id
	 */
